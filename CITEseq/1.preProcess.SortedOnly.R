...
#set up how the lanes of the 10x will be assigned to different Seurat objects depending on the different cell groups in the experiment. 
...
rawdir = "H5DataFromGEO" ### set to the location of the downloaded cell ranger H5 data
...
ObjList["MergeBcells"] <- merge(ObjList[[1]], ObjList[2])
...
write.csv(table(ObjList[[1]]$hash.ID, ObjList[[1]]$autoHashcalls), "CountsPerSample/SPosBcells.CellsPerSample.HashCalls.Overlap.csv")
write.csv(table(ObjList[[2]]$hash.ID, ObjList[[2]]$autoHashcalls), "CountsPerSample/SNegBcells.CellsPerSample.HashCalls.Overlap.csv")
write.csv(table(ObjList[[3]]$hash.ID, ObjList[[3]]$autoHashcalls), "CountsPerSample/CD4Tcells.CellsPerSample.HashCalls.Overlap.csv")
write.csv(table(ObjList[[4]]$hash.ID, ObjList[[4]]$autoHashcalls), "CountsPerSample/CD8Tcells.CellsPerSample.HashCalls.Overlap.csv")
write.csv(table(ObjList[[5]]$hash.ID, ObjList[[5]]$autoHashcalls), "CountsPerSample/MergeBcells.CellsPerSample.HashCalls.Overlap.csv")

write.csv(table(ObjList_filt[[1]]$autoHashcalls), "CountsPerSample/SPosBcells.CellsPerSample.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[2]]$autoHashcalls), "CountsPerSample/SNegBcells.CellsPerSample.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[3]]$autoHashcalls), "CountsPerSample/CD4Tcells.CellsPerSample.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[4]]$autoHashcalls), "CD8Tcells.CellsPerSample.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[5]]$autoHashcalls), "CountsPerSample/MergeBcells.CellsPerSample.gatingHashCalls.csv")
...
write.csv(table(ObjList_filt[[1]]$Sample_Tissue_Class), "CountsPerSample/SPosBcells.CellsPerSampleTissueClass.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[2]]$Sample_Tissue_Class), "CountsPerSample/SNegBcells.CellsPerSampleTissueClass.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[3]]$Sample_Tissue_Class), "CountsPerSample/CD4Tcells.CellsPerSampleTissueClass.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[4]]$Sample_Tissue_Class), "CountsPerSample/CD8Tcells.CellsPerSampleTissueClass.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[5]]$Sample_Tissue_Class), "CountsPerSample/MergeBcells.CellsPerSampleTissueClass.gatingHashCalls.csv")
write.csv(table(ObjList_filt[[5]]$Sample_Tissue_Class,  ObjList_filt[[5]]$Type), "CountsPerSample/MergeBcells.CellsPerSampleTissueClassPersortedtype.gatingHashCalls.csv")

saveRDS(ObjList_filt, "SeuratObjects/ObjList_filt.preprocessed.ADTclustered.wMeta.Rds")
saveRDS(ObjList_filt[[5]], "SeuratObjects/SortedBcells.preprocessed.ADTclustered.wMeta.Rds")
