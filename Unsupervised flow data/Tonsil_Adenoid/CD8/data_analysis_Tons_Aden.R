...
plotModelRes(mod.list = mod_Adenoid,
  ...
  egg::set_panel_size(width = unit(4, "in"),
                      height = unit(4, "in")) %>%
  gridExtra::grid.arrange()  %>%
  ggsave(filename = "stats.Adenoid_CD8.pdf",
         width = 14,
         height = 6,
         useDingbats = FALSE)
...
plotModelRes(mod.list = mod_Tonsil,
  ...
  egg::set_panel_size(width = unit(4, "in"),
                      height = unit(4, "in")) %>%
  gridExtra::grid.arrange()  %>%
  ggsave(filename = "stats.Tonsil_CD8.pdf",
         width = 14,
         height = 6,
         useDingbats = FALSE)
...
top.prot.HM[[4]] %>%
  gridExtra::grid.arrange() %>%
  ggsave(filename = "211223_HM_markers_Tons_Aden_CD8.pdf",
         width = 5,
         height = 3,
         useDingbats = FALSE)
...
markers %>%
  ...
  do.call(gridExtra::grid.arrange,
          .) %>%
  ggsave(filename = "211226_UMAP_markers_Tons_Aden_CD8.pdf",
         width = 15,
         height = 15,
         useDingbats = FALSE)
